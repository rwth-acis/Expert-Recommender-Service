...
public class CommunityAwarePageRankStrategy implements ScoreStrategy {
     ...
     * @param nodeId2Covers
     */
    public CommunityAwarePageRankStrategy(Graph<String, RelationshipEdge> graph, Map<Long, UserEntity> userId2userObj,
	...
	CAwarePageRank<String, RelationshipEdge> ranker = new CAwarePageRank<String, RelationshipEdge>(graph, alpha, nodeId2Covers);
