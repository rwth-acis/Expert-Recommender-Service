	 ...
	 $.post( url, query)
	  	.done(function( data ) {
	    	...
	    	for(i =0 ; i < result.length ; i++) {
	    		var template_node = "<div class='list_item'><div class='profile_pic'></div><div class='user_details'><div class='name'>"+result[i].userName+"</div><div class='email'>Reputaiton: "+result[i].reputation+"</div></div><div class='related_post'>"+result[i].websiteUrl+"</div><div class='related_topics'>Related_topics</div></div>";
